...
public interface IModalService
{
	...
	void ShowModal(MoveNodeViewModel viewModel, NavigationItemViewModel? relatedItem);
	void ShowModal(RenameNodeViewModel viewModel, NavigationItemViewModel? relatedItem);
}
